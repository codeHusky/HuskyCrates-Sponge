...
public class Particle {
    ...
    public void run(long tick, Location<World> location){
        ...
        try {
            ScriptObjectMirror scriptObjectMirror = (ScriptObjectMirror)engine.eval("var time = " + tick + "; var x = 0.0; var y = 0.0; var z = 0.0; " + animationCode + "; var result = {x:x,y:y,z:z}; result;");
